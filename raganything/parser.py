    ...
    def _read_output_files(
        ...
        *,
        ...
        Args:
            ...
            fix_image_paths: If True, rewrite relative img paths to absolute (default).
                If False, return content_list as-is for read-only/light load (e.g. agent page context).
